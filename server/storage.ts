...
export interface IStorage {
  ...
  // Votes
  castVote(pairId: string, userId: string, voteData: Pick<InsertVote, "scoreBinary" | "scoreNumeric" | "scoreExclusion" | "scoringMode" | "expertSelectedCode" | "reviewerNotes">, config: CampaignConfig): Promise<{ vote: Vote; evidenceStatus: EvidenceStatus }>;
...
export class DatabaseStorage implements IStorage {
  ...
  async castVote(
    pairId: string,
    userId: string,
    voteData: Pick<InsertVote, "scoreBinary" | "scoreNumeric" | "scoreExclusion" | "scoringMode" | "expertSelectedCode" | "reviewerNotes">,
